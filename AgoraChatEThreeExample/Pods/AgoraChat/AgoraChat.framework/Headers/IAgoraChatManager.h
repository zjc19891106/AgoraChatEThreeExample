 ...
 */
typedef enum {
    EMMessageFetchHidtoryDirectionUp  = 0,    /** \~chinese 向上搜索类型。  \~english The  older messages type.*/
    EMMessageFetchHidtoryDirectionDown        /** \~chinese 向下搜索类型。 \~english The  newer messages type.*/
} EMMessageFetchHidtoryDirection;
 ...
 *  @param  direction      EMMessageFetchHidtoryDirection 根据某条消息向上或者向下
 ...
 *  @param direction      EMMessageFetchHidtoryDirection up or down
...
- (AgoraChatCursorResult *)fetchHistoryMessagesFromServer:(NSString *)aConversationId
                                  conversationType:(AgoraChatConversationType)aConversationType
                                    startMessageId:(NSString *)aStartMessageId
                                       fetchDirection:(EMMessageFetchHidtoryDirection)direction
 ...
 *  @param  aConversationType   要获取消息的 Conversation type。
 *  @param  aStartMessageId     起始消息的 ID。
 *  @param direction      EMMessageFetchHidtoryDirection 向上或者向下
 ...
 *  \~chinese
 *  发送消息已读回执。
 *  已废弃，请用 {@link IAgoraChatManager sendMessageReadAck:toUser:completion:} 代替。
 *  异步方法。
 *
 *  @param aMessage             消息。
 *  @param aCompletionBlock     该方法完成调用的回调。如果该方法调用失败，会包含调用失败的原因。
 ...
 *  Deprecated. Please use {@link IAgoraChatManager sendMessageReadAck:toUser:completion:} instead.
 *  This is an asynchronous method.
 *
 *  @param aMessage             The message instance.
 *  @param aCompletionBlock     The completion block, which contains the error message if the method fails.
 ...
 *  \~chinese
 *  撤回消息。
 *  已废弃，请用 {@link IAgoraChatManager recallMessageWithMessageId:completion:} 代替。
 *  异步方法。
 *
 *  @param aMessage             消息。
 *  @param aCompletionBlock     该方法完成调用的回调。如果该方法调用失败，会包含调用失败的原因。
 ...
 *  \~english
 *  Recalls a message.
 *  Deprecated. Please use {@link IAgoraChatManager recallMessageWithMessageId:completion:} instead.
 *  This is an asynchronous method.
 *
 *  @param aMessage             The message instance.
 *  @param aCompletionBlock     The completion block, which contains the error message if the method fails.
 ...
 *
 *  @result AgoraChatMessage NSArray.
 *
 */
