 ...
 */
typedef enum {
    AgoraChatTypeChat   = 0,   /** \~chinese 单聊。  \~english One-to-one chat. */
    AgoraChatTypeGroupChat,    /** \~chinese 群聊。  \~english Group chat. */
    AgoraChatTypeChatRoom,     /** \~chinese 聊天室。  \~english Chatroom. */
} AgoraChatType;
 ...
 */
typedef enum {
    AgoraChatMessageStatusPending  = 0,    /** \~chinese 发送未开始。 \~english Message delivery is pending.*/
    AgoraChatMessageStatusDelivering,      /** \~chinese 正在发送。 \~english The message is being delivered.*/
    AgoraChatMessageStatusSucceed,         /** \~chinese 发送成功。 \~english The message is successfully delivered.*/
    AgoraChatMessageStatusFailed,          /** \~chinese 发送失败。 \~english The message fails to be delivered.*/
 ...
 */
typedef enum {
    AgoraChatMessageDirectionSend = 0,    /** \~chinese 该消息是当前用户发送出去的。\~english This message is sent from the local client.*/
    AgoraChatMessageDirectionReceive,     /** \~chinese 该消息是当前用户接收到的。 \~english The message is received by the local client.*/
 ...
 *
 *  \~english
 *  Is it a message that contains an overview of the thread.
 */
@property (nonatomic) BOOL isChatThread;
 ...
 */
@property (readonly) AgoraChatThreadEvent *threadOverView;
/**
 *  \~chinese
 *  初始化消息实例。
 *
