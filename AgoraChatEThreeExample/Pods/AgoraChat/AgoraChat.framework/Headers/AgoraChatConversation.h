 ...
 */
typedef enum {
    AgoraChatConversationTypeChat = 0,    /** \~chinese 单聊会话类型。  \~english The one-to-one chat type. */
    AgoraChatConversationTypeGroupChat,    /** \~chinese 群聊会话类型。  \~english The group chat type.*/
    AgoraChatConversationTypeChatRoom,      /** \~chinese 聊天室会话类型。 \~english The chat room type.*/
 ...
 *  @param aDirection  The message search direction: EMMessageSearchDirection.
 *
 *  @result The message NSArray. See <AgoraChatMessage>.
 */
