 ...
 *  是否允许使用 DNS, 默认为 YES。
 *
 *  只能在 {@link AgoraChatClient initializeSDKWithOptions:} 中设置，不能在程序运行过程中动态修改。
 *
 *  \~english
 ...
 *  Chat 服务器端口。
 *
 *  enableDnsConfig 为 NO 时有效。只能在 {@link AgoraChatClient initializeSDKWithOptions:} 中设置，不能在程序运行过程中动态修改。
 *
 *  \~english
 ...
 *  The chat 服务器地址。
 *
 *  enableDnsConfig 为 NO 时生效。只能在 {@link AgoraChatClient initializeSDKWithOptions:} 中设置，不能在程序运行过程中动态修改。
 *
 *  \~english
 *  The chat server.
 *
 ...
 *  DNS URL 地址。
 *
 *  enableDnsConfig为YES时生效，只能在 {@link AgoraChatClient initializeSDKWithOptions:} 中设置，不能在程序运行过程中动态修改。
 *
 *  \~english
 *  The DNS url.
 *
