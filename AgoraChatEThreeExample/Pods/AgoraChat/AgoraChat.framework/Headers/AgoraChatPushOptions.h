...
typedef enum {
    AgoraChatPushNoDisturbStatusDay = 0,
    AgoraChatPushNoDisturbStatusCustom,
    AgoraChatPushNoDisturbStatusClose,
} AgoraChatPushNoDisturbStatus EM_DEPRECATED_IOS(3_1_0, 3_7_2, "");

@property (nonatomic) AgoraChatPushNoDisturbStatus noDisturbStatus EM_DEPRECATED_IOS(3_1_0, 3_7_2, "");
