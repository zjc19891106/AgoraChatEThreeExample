...
/*!
 *  \~chinese
 *  获取thread对象，如果本地没有回去服务器请求
 *
 *  @param threadId 要获取的子区的id
 *  @param aCompletionBlock 返回回调，包含一个AgoraChatThread对象跟一个AgoraChatError的错误对象
 *  \~english
 *  Get the thread object, if the local does not go back to the server request
 ...
 */
- (void)getChatThreadWithId:(NSString *)threadId completion:(void (^)(AgoraChatThread *thread, AgoraChatError *aError))aCompletionBlock;
/*!
 *  \~chinese
 *  获取thread详情
 *
 ...
 *  @param aCompletionBlock Returns the callback, containing an AgoraChatThread object and an AgoraChatError error object
 */
- (void)getChatThreadDetail:(NSString *)threadId completion:(void (^)(AgoraChatThread *thread, AgoraChatError *aError))aCompletionBlock;
/*!
 *  \~chinese
 *  从服务器获取用户已加入的子区
 *
 ...
 *  @param aCompletionBlock 返回回调，包含一个AgoraChatCursorResult对象跟一个AgoraChatError的错误对象
 *  \~english
...
- (void)getJoinedChatThreadsFromServerWithCursor:(NSString *)aCursor
                               ...
                               completion:(void (^)(AgoraChatCursorResult*result, AgoraChatError *aError))aCompletionBlock;
/*!
 *  \~chinese
 *  从服务器获取一个群组下的子区
 *
 ...
 *  @param aCompletionBlock Returns the callback, containing an AgoraChatCursorResult object and an AgoraChatError error object
 */
- (void)getChatThreadsFromServerWithParentId:(NSString *)parentId cursor:(NSString *)aCursor pageSize:(NSInteger)aPageSize completion:(void (^)(AgoraChatCursorResult *result, AgoraChatError *aError))aCompletionBlock;
/*!
 *  \~chinese
 *  从服务器获取一个群组下我加入的子区
 *
 ...
 *  @param aCompletionBlock Returns the callback, containing an AgoraChatCursorResult object and an AgoraChatError error object
 */
- (void)getMineChatThreadsFromServerWithParentId:(NSString *)parentId cursor:(NSString *)aCursor pageSize:(NSInteger)aPageSize completion:(void (^)(AgoraChatCursorResult *result, AgoraChatError *aError))aCompletionBlock;
/*!
 *  \~chinese
 *  从服务器获取一个子区的成员列表
 *
 ...
 *  @param aCompletionBlock Returns the callback, containing an AgoraChatCursorResult object and an AgoraChatError error object
 */
- (void)getChatThreadMemberListFromServerWithId:(NSString *)threadId cursor:(NSString *)aCursor pageSize:(NSInteger)pageSize completion:(void (^)(AgoraChatCursorResult *aResult, AgoraChatError *aError))aCompletionBlock;
 ...
 *  @param aCompletionBlock 返回回调，包含一个字典key是子区id，value是AgoraChatMessage对象
 *  \~english
 *  Get the thread detail
 ...
 */
- (void)getLastMesssageFromSeverWithChatThreads:(NSArray <NSString *>*)threadIds completion:(void (^)(NSDictionary<NSString*,AgoraChatMessage*>*messageMap, AgoraChatError *aError))aCompletionBlock;
/*!
 *  \~chinese
 *  移除子区成员（仅群管理可用）
 *
 ...
 *  @param subject the name you want to change（limit 64 character）
 *  @param threadId subarea id to operate
 *  @param aCompletionBlock return callback, success or failure
 */
- (void)updateChatThreadSubject:(NSString *)subject
                  threadId:(NSString *)athreadId
                 completion:(void (^)(AgoraChatError *aError))aCompletionBlock;
/*!
 *  \~chinese
 ...
 *  @param completion 返回回调，包含一个AgoraChatThread对象跟一个AgoraChatError的错误对象
 *  \~english
 *  Create a subsection
 ...
 */
- (void)createChatThread:(NSString *)threadName messageId:(NSString *)messageId parentId:(NSString *)parentId completion:(void (^)(AgoraChatThread *thread,AgoraChatError *aError))aCompletionBlock;
/*!
 *  \~chinese
 *  加入一个子区
 *
 ...
 *  @param aCompletionBlock return callback, success or failure
 */
- (void)joinChatThread:(NSString *)threadId completion:(void (^)(AgoraChatThread *thread,AgoraChatError *aError))aCompletionBlock;
 ...
 *  @param aCompletionBlock return callback, success or failure
 */
- (void)leaveChatThread:(NSString *)athreadId completion:(void (^)(AgoraChatError *aError))aCompletionBlock;
 ...
 *  @param aCompletionBlock return callback, success or failure
 */
- (void)destoryChatThread:(NSString *)athreadId completion:(void (^)(AgoraChatError *aError))aCompletionBlock;
