 ...
 *  @param aGroupId   群组 ID。
 *
 *  @result AgoraChatError   错误信息。成功返回 nil。
 *
 *  \~english
 *  Destroys a group.
 * 
 ...
 *  同步方法，会阻塞当前线程。
 * 
 *  已废弃，请用 {@link IAgoraChatPushManager::updatePushServiceForGroups:disablePush:} 代替。
 *
 *  @param aGroupId    群组 ID。
 *  @param aIgnore     是否屏蔽。
 *
 ...
 *  屏蔽/取消屏蔽群组消息的推送。
 * 
 *  已废弃，请用 {@link IAgoraChatPushManager::updatePushServiceForGroups:disablePush:completion:} 代替。
 *
 *  @param aGroupId          群组 ID。
 ...
 *  @result    The group list.
 */
- (NSArray *)getMyGroupsFromServerWithError:(AgoraChatError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use - getJoinedGroupsFromServerWithPage:pageSize:error:");
 ...
 *
 */
- (void)getJoinedGroupsFromServerWithCompletion:(void (^)(NSArray *aList, AgoraChatError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use - getJoinedGroupsFromServerWithPage:pageSize:completion:");
...
- (AgoraChatGroup *)fetchGroupInfo:(NSString *)aGroupId
         includeMembersList:(BOOL)aIncludeMembersList
                      error:(AgoraChatError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use - getGroupSpecificationFromServerWithId:error:");
...
- (void)getGroupSpecificationFromServerByID:(NSString *)aGroupID
                         includeMembersList:(BOOL)aIncludeMembersList
                                 completion:(void (^)(AgoraChatGroup *aGroup, AgoraChatError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use - getGroupSpecificationFromServerWithId:completion:");
...
- (NSArray *)fetchGroupBansList:(NSString *)aGroupId
                          error:(AgoraChatError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use - getGroupBlacklistFromServerWithId:pageNumber:pageSize:error:");
...
- (void)getGroupBlackListFromServerByID:(NSString *)aGroupId
                             completion:(void (^)(NSArray *aList, AgoraChatError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use - getGroupBlacklistFromServerWithId:pageNumber:pageSize:completion:");
...
- (AgoraChatGroup *)destroyGroup:(NSString *)aGroupId
                    error:(AgoraChatError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use - destroyGroup:");
 ...
 */
- (void)destroyGroup:(NSString *)aGroupId
          completion:(void (^)(AgoraChatGroup* aGroup, AgoraChatError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use - destroyGroup:finishCompletion:");
 ...
 *  @param aDelegate  The delegate to be added.
 */
- (void)addDelegate:(id<AgoraChatGroupManagerDelegate>)aDelegate EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use - addDelegate:delegateQueue:");
 ...
 *  从内存中获取屏蔽了推送的群组 ID 列表。
 * 
 *  已废弃，请用 {@link IAgoraChatPushManager::noPushGroups} 代替。
 *
 *  @result 群组 ID列表。
 *
 *  \~english
 ...
 * 
 *  Deprecated, please use  {@link IAgoraChatPushManager::noPushGroups}   instead.
 *
 *  @result The group ID list. 
 */
- (NSArray *)getAllIgnoredGroupIds __deprecated_msg("Use -IAgoraChatPushManager::noPushGroups instead");
...
- (void)asyncGetMyGroupsFromServer:(void (^)(NSArray *aList))aSuccessBlock
                           failure:(void (^)(AgoraChatError *aError))aFailureBlock __deprecated_msg("Use -getJoinedGroupsFromServerWithCompletion: instead");
...
- (void)asyncGetPublicGroupsFromServerWithCursor:(NSString *)aCursor
                                        pageSize:(NSInteger)aPageSize
                                         ...
                                         failure:(void (^)(AgoraChatError *aError))aFailureBlock __deprecated_msg("Use -getPublicGroupsFromServerWithCursor:pageSize:completion: instead");
...
- (void)asyncSearchPublicGroupWithId:(NSString *)aGroundId
                             ...
                             failure:(void (^)(AgoraChatError *aError))aFailureBlock __deprecated_msg("Use -searchPublicGroupWithId:completion: instead");
 ...
 *
 *  \~english
 *  Applies to join a public group. The group style should be AgoraChatGroupStylePublicJoinNeedApproval.
 * 
