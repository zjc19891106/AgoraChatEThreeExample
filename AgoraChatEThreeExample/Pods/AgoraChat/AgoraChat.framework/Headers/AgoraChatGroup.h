 ...
 */
typedef enum{
    AgoraChatGroupPermissionTypeNone   = -1,    /** \~chinese 未知类型。 \~english The unknown type.*/
    AgoraChatGroupPermissionTypeMember = 0,     /** \~chinese 普通成员。  \~english The group member.*/
    AgoraChatGroupPermissionTypeAdmin,          /** \~chinese 群组管理员。 \~english The group admin.*/
    AgoraChatGroupPermissionTypeOwner,          /** \~chinese 群主。 \~english The group owner.*/
